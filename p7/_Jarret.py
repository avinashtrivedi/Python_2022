...
class UserPredictor:
    ...
    def fit(self, users, logs, y):
        ...
        #print(cross_val_score(self.model, m[['past_purchase_amt', 'age','seconds', 'count']], train_y['y']).mean())
        #print(cross_val_score(self.model, m[['past_purchase_amt', 'age','seconds', 'count']], train_y['y']).std())
